...
//  import neotypes.generic.auto._
  //https://github.com/neotypes/neotypes/issues/209 fix
  ...
  val user = "neo4j"
  val pw = "needrealpw" //TODO get it from enviroment not hard code it
  val host = "54.210.172.235"
  val port = 33193
  ...
  val peopleRes = Await.result(peopleCC, 5.second)
  peopleRes.foreach(println)
